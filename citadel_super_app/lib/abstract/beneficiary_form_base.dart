...
abstract class DetailsForm extends StatefulHookConsumerWidget {
...
class CorporateAddEditBeneficiaryDetailPageState
    extends ConsumerState<DetailsForm> {
    ...
    useEffect(() {
      WidgetsBinding.instance.addPostFrameCallback((_) {
        if (widget.guardian != null) {
          ...
          documentNumberController.text = widget.guardian.icPassportDisplay;
            ...
            child: Column(
              ...
              children: [
                ...
                AppResidentialStatusFormField(
                  formKey: widget.formKey,
                  initialValue: widget.beneficiary?.residentialStatus != null
                      ? getValueForKey(
                          widget.beneficiary?.residentialStatus ?? '', ref)
                      : widget.guardian?.residentialStatus != null
                          ? getValueForKey(
                              widget.guardian.residentialStatusDisplay, ref)
                          : '',
                  enabled: widget.isEnabled,
                ...
                if ((widget.beneficiary == null && widget.guardian == null) ||
                  ...
                  AppDocumentImageFormField(
                    documentType: widget.beneficiary?.identityDocumentType ??
                        widget.guardian?.identityDocumentType ??
                        microblinkState?.docType ?? 'MYKAD',
                ...
                PrimaryButton(
                  ...
                  onTap: () =>
                      (widget.beneficiary != null || widget.guardian != null) &&
                              widget.isEdit == true
                          ? widget.onEdit(context, ref, widget.formKey)
                          : widget.onCreate(context, ref, widget.formKey),
                  title: 'Confirm',
                ),
                gapHeight16,
