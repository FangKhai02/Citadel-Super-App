...
ExistingClientResponseVo _$ExistingClientResponseVoFromJson(
    Map<String, dynamic> json) {
  return _ExistingClientResponseVo.fromJson(json);
}

/// @nodoc
mixin _$ExistingClientResponseVo {
  ...
  String? get agentReferralCode => throw _privateConstructorUsedError;
  set agentReferralCode(String? value) => throw _privateConstructorUsedError;
  String? get password => throw _privateConstructorUsedError;
  set password(String? value) => throw _privateConstructorUsedError;

  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;
  @JsonKey(ignore: true)
  $ExistingClientResponseVoCopyWith<ExistingClientResponseVo> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $ExistingClientResponseVoCopyWith<$Res> {
  factory $ExistingClientResponseVoCopyWith(ExistingClientResponseVo value,
          $Res Function(ExistingClientResponseVo) then) =
      _$ExistingClientResponseVoCopyWithImpl<$Res, ExistingClientResponseVo>;
  @useResult
  $Res call(
      {String? code,
      String? message,
...
/// @nodoc
class _$ExistingClientResponseVoCopyWithImpl<$Res,
        $Val extends ExistingClientResponseVo>
    implements $ExistingClientResponseVoCopyWith<$Res> {
  _$ExistingClientResponseVoCopyWithImpl(this._value, this._then);
  ...
  $Res call({
    ...
    Object? agentReferralCode = freezed,
    ...
    return _then(_value.copyWith(
      ...
      digitalSignature: freezed == digitalSignature
          ...
          : digitalSignature // ignore: cast_nullable_to_non_nullable
              as String?,
      agentReferralCode: freezed == agentReferralCode
          ? _value.agentReferralCode
          : agentReferralCode // ignore: cast_nullable_to_non_nullable
              as String?,
...
/// @nodoc
abstract class _$$ExistingClientResponseVoImplCopyWith<$Res>
    implements $ExistingClientResponseVoCopyWith<$Res> {
  factory _$$ExistingClientResponseVoImplCopyWith(
          _$ExistingClientResponseVoImpl value,
          $Res Function(_$ExistingClientResponseVoImpl) then) =
      __$$ExistingClientResponseVoImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {String? code,
...
/// @nodoc
class __$$ExistingClientResponseVoImplCopyWithImpl<$Res>
    extends _$ExistingClientResponseVoCopyWithImpl<$Res,
        _$ExistingClientResponseVoImpl>
    implements _$$ExistingClientResponseVoImplCopyWith<$Res> {
  __$$ExistingClientResponseVoImplCopyWithImpl(
      _$ExistingClientResponseVoImpl _value,
      $Res Function(_$ExistingClientResponseVoImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$ExistingClientResponseVoImpl(
      code: freezed == code
          ? _value.code
          : code // ignore: cast_nullable_to_non_nullable
              as String?,
...
/// @nodoc
@JsonSerializable()
class _$ExistingClientResponseVoImpl extends _ExistingClientResponseVo {
  _$ExistingClientResponseVoImpl(
      {this.code,
      this.message,
  ...
  factory _$ExistingClientResponseVoImpl.fromJson(Map<String, dynamic> json) =>
      _$$ExistingClientResponseVoImplFromJson(json);
  ...
  @override
  String toString() {
    return 'ExistingClientResponseVo(code: $code, message: $message, identityDetails: $identityDetails, personalDetails: $personalDetails, selfieImage: $selfieImage, pepDeclaration: $pepDeclaration, employmentDetails: $employmentDetails, digitalSignature: $digitalSignature, agentReferralCode: $agentReferralCode, password: $password)';
  }

  @JsonKey(ignore: true)
  @override
  @pragma('vm:prefer-inline')
  _$$ExistingClientResponseVoImplCopyWith<_$ExistingClientResponseVoImpl>
      get copyWith => __$$ExistingClientResponseVoImplCopyWithImpl<
          _$ExistingClientResponseVoImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$ExistingClientResponseVoImplToJson(
      this,
    );
  }
}

abstract class _ExistingClientResponseVo extends ExistingClientResponseVo {
  factory _ExistingClientResponseVo(
      {String? code,
      String? message,
      ClientIdentityDetailsRequestVo? identityDetails,
      ClientPersonalDetailsRequestVo? personalDetails,
      ...
      String? digitalSignature,
      String? agentReferralCode,
      String? password}) = _$ExistingClientResponseVoImpl;
  _ExistingClientResponseVo._() : super._();

  factory _ExistingClientResponseVo.fromJson(Map<String, dynamic> json) =
      _$ExistingClientResponseVoImpl.fromJson;
  ...
  @override
  String? get agentReferralCode;
  set agentReferralCode(String? value);
  @override
  String? get password;
