...
/// @nodoc
@JsonSerializable()
class _$ResetPasswordRequestImpl extends _ResetPasswordRequest {
  _$ResetPasswordRequestImpl({this.email, this.password, this.token})
      : super._();
  ...
  @override
  String toString() {
    return 'ResetPasswordRequest(email: $email, password: $password, token: $token)';
  }
...
abstract class _ResetPasswordRequest extends ResetPasswordRequest {
  factory _ResetPasswordRequest(
      {String? email,
      String? password,
      String? token}) = _$ResetPasswordRequestImpl;
  _ResetPasswordRequest._() : super._();
