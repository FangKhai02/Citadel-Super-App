...
class PortfolioWidget extends HookConsumerWidget {
  final bool isCorporate;
  const PortfolioWidget({super.key, this.isCorporate = false});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final portfolio = ref.watch(clientPortfolioFutureProvider);
          ...
          SizedBox(
            ...
            child: ListView.builder(
                ...
                itemBuilder: (BuildContext context, int index) {
                  return PortfolioContainer(portfolio: portfolios[index]);
                }),
          )
        ],
      );
