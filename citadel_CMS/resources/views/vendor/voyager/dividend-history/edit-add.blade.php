...
@section('page_header')
    ...
    <div class="col-md-12" style="margin-bottom: 10px">
        <form action="{{ route('dividend-history.generate-bank-file', $dataTypeContent->getKey()) }}" method="POST"
        ...
        @if ($dataTypeContent->bank_result_csv)
            <form action="{{ route('dividend-history.update-dividend-payment', $dataTypeContent->getKey()) }}"
            ...
            <div class="panel panel-bordered">
                <div class="panel-body">
                    ...
                    <label class="control-label" for="name">
                        ...
                        (Note: Convert to .xlsx file before uploading the dividend file.)
                        </small>
                    </label>
                    <div class="mt-2">
                        <a href=https://sgp1.digitaloceanspaces.com/nexstream-dev/citadel/settings/March2025/bank-sample-file.xlsx
                        class="btn btn-sm btn-info" 
                        download>
                        <i class="voyager-file-text"></i> Download Sample File
                        </a>
                    </div>
                    </div>
                </div>
