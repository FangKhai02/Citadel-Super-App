...
@section('page_header')
    ...
    <div class="col-md-12" style="margin-bottom: 10px">
        <form action="{{ route('withdrawal-history.generate-bank-file', $dataTypeContent->getKey()) }}" method="POST"
        ...
        @if ($dataTypeContent->bank_result_csv)
            <form action="{{ route('withdrawal-history.update-withdrawal-payment', $dataTypeContent->getKey()) }}"
                method="POST" style="display:inline-block; margin-left: 10px;">
                @csrf
                <button type="submit" class="btn btn-success">
                    Update Withdrawal Payment
                </button>
            </form>
        @endif
    </div>
            ...
            <div class="panel panel-bordered">
                <div class="panel-body">
                    ...
                    <label class="control-label" for="name">
                        ...
                        (Note: Convert to .xlsx file before uploading the result file.)
                        </small>
                    </label>
                    <div class="mt-2">
