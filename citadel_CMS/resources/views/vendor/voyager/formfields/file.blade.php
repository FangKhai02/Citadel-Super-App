@if(isset($dataTypeContent->{$row->field}))
    ...
    @endif
@endif
<input @if($row->required == 1 && !isset($dataTypeContent->{$row->field})) required @endif type="file" name="{{ $row->field }}" id="fileInput"
@if($row->field == 'product_catalogue_url') accept="application/pdf" @endif>
