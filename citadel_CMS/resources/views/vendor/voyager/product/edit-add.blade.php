...
<div class="modal fade" id="fileOverrideModal" tabindex="-1" role="dialog" aria-labelledby="fileOverrideModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                You have uploaded a new file. Do you want to override the Document Editor with the new file? Any changes
                made in the editor will be discarded if you choose to override.
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal"
                    onclick="handleConfirmOverride(false)">No, Keep Changes</button>
                <button type="button" class="btn btn-primary" onclick="handleConfirmOverride(true)">Yes,
                    Override</button>
            </div>
        </div>
    </div>
...
<script>
    ...
    $(document).ready(function() {
        // File upload handling code (conditional)
        @if ($edit)
        ...
        // General initialization code (unconditional)
