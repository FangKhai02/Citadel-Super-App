...
@section('page_header')
    ...
    <!-- Custom Button -->
    {{-- @if ($dataTypeContent->status_checker == 'APPROVE_CHECKER' && $dataTypeContent->status_approver == 'APPROVE_APPROVER') --}}
    <div class="col-md-12" style="margin-bottom: 10px">
        <form action="{{ route('product-commission-history.generate-bank-file', $dataTypeContent->getKey()) }}" method="POST"
        ...
        @if ($dataTypeContent->bank_result_csv)
            <form action="{{ route('product-commission-history.update-commission-payment', $dataTypeContent->getKey()) }}"
...
@section('content')
    <div class="page-content edit-add container-fluid">
        <div class="row">
            <div class="col-md-12">
                @if ($dataTypeContent->generated_bank_file)
                ...
                <div class="panel-body">
                    ...
                    <label class="control-label" for="name">
                        ...
                        (Note: Convert to .xlsx file before uploading the commission file.)
                        </small>
                    </label>
                    <div class="mt-2">
                        <a href="{{ $fileUrl }}" class="btn btn-sm btn-info" download>
                            <i class="voyager-file-text"></i> Download Sample Payment Update File
                        </a>
                    </div>
                    </div>
                </div>
