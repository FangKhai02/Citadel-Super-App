...
@section('page_title', isset($bankDetails) ? 'Edit Client Banking Details' : 'Create Client Banking Details')

@section('page_header')
    <h1 class="page-title">
        <i class="voyager-wallet"></i>
        {{ isset($bankDetails) ? 'Edit Client Banking Details' : 'Create Client Banking Details' }}
    </h1>
@stop
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-bordered">
                    <form role="form"
                          action="{{ isset($bankDetails) ? route('update.client.banking.details', ['client_id' => $client->id, 'id' => $bankDetails->id]) : route('store.client.banking.details', ['id' => $client->id]) }}"
                        ...
                        <div class="panel-body">
                            ...
                            <!-- Bank Account Proof -->
                            <div class="form-group @if(isset($bankDetails) && $bankDetails->bank_account_proof_key) has-image @endif">
                                ...
                                @if(isset($bankDetails) && $bankDetails->bank_account_proof_key)
                                    <img src="{{ asset('storage/' . $bankDetails->bank_account_proof_key) }}" alt="Bank Account Proof">
                                @endif
                            </div>
