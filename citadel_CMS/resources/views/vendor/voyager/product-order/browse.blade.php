                                                            ...
                                                            @if (method_exists($action, 'getDropdownActions') && count($action->getDropdownActions($data)) > 0)
                                                                ...
                                                                <div class="custom-dropdown-menu dropdown-menu">
                                                                    @foreach ($action->getDropdownActions($data) as $dropdownAction)
                                                                        <a class="{{ $dropdownAction['attributes']['class'] }} custom-dropdown-item"
                                                                            href="{{ $dropdownAction['route'] }}">
                                                                            <i
                                                                                class="voyager {{ $dropdownAction['icon'] }}"></i>
