...
@section('page_header')
    ...
    <div class="col-md-12" style="margin-bottom: 10px">
        <form action="{{ route('product-redemption.generate-bank-file', $dataTypeContent->getKey()) }}" method="POST"
        ...
        @if ($dataTypeContent->bank_result_csv)
            <form action="{{ route('product-redemption.update-redemption-payment', $dataTypeContent->getKey()) }}"
                method="POST" style="display:inline-block; margin-left: 10px;">
                @csrf
                <button type="submit" class="btn btn-success">
                    Update Redemption Payment
                </button>
            </form>
        @endif
    </div>
