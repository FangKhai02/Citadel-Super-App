...
class ProductAgreementSchedulePivot extends Model
{
    protected $table = 'product_agreement_schedule_pivot';
    use HasFactory;
    ...
    {
        return $this->belongsTo(ProductAgreementSchedule::class, 'product_agreement_schedule_id');
    }
}
