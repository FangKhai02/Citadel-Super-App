...
class ProductReallocation extends Model
{
    use HasFactory;
    protected $table              = 'product_reallocation';
    ...
    public function reallocateProduct()
    {
        return $this->belongsTo(Product::class, 'reallocate_product_id');
    }
    ...
    public function getClientNameAttribute()
    {
        if ($this->client_id != null) {
            ...
            return $this->corporateClient->userDetails->name;
        } else {
            return "-";
        }
    ...
    public function getProductNameAttributes()
    {
        return $this->productOrder->product->name ?? ' ';
    }
