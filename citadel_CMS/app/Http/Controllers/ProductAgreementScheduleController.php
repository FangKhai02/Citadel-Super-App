...
class ProductAgreementScheduleController extends CustomVoyagerBaseController
{
    public function index(Request $request)
    {
        ...
        if (strlen($dataType->model_name) != 0) {
            ...
            if ($request->has('product_id')) {
                ...
                $productType = ProductType::find($productId);
                if ($productType) {
                    ...
                    $query->whereIn('id', $productAgreementScheduleIds);
                }
            }
